...
const skills = ['Figma', 'Python', 'Inkscape', 'JavaScript', 'AdobeXD', 'React Native', 'GraphQL', 'Affinity Photo', 'CSS', 'Node', 'SQL', 'Flask', 'Wordpress', 'WebRTC', 'CentOS', 'Jest', 'Git', 'React', 'Stripe', 'Ubuntu', 'Jenkins', 'AWS', 'Bash'] 
